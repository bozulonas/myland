...
### Step 1: Who Answers your Prayers?

<div id="god-generator"></div>

### Step 2: Witness Their Visage

Defined by GM based on the god generated above

> GM Only Links
> [Tome of Adventure Design](https://drive.google.com/file/d/1taeQm7sfrI1pieTZhrBAx9pbw5GS7ttp/view?usp=drive_link#page=53)
> [God appearance generator](https://gemini.google.com/gem/bcb652c5478b)
...
---
![[Pasted image 20251107221240.png]]
## Divine Domains Reference

This section details all available divine domains for the Priest class. Each domain has specific mandates (commands) that must be followed and invocations that can be invoked.
...
**Smite**
*Range*: 100'; *Target*: 1 creature or object; *Duration*: instant. Deal **[sum]** damage to the target, forcing it to fall prostrate. They must make a save to stand up.

**Summon Minor Spirit of Judgment**
*Range*: N/A; *Target*: N/A; *Duration*: **[dice]** hours. Summon a minor spirit of law adjacent to you. It has **[dice]x*4 HP**, can fly, and projects a **[dice]*10'** radius field that enforces the law. It follows your commands to the letter, so long as they are consistent with the law.
